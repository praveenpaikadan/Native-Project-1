                ...
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.dataContainer}>
                        <View style={styles.dataTopContainer}>
                            ...
                            <View style={{...styles.infoRightContainer, display:displayStatus,}}>                
                        ...
                        <View style={{...styles.dataBottomContainer, display:displayStatus}}>
                            <View style={{...styles.weightSliderComponent}}>
                                <Text style={styles.hwTag}>Set your weight :</Text>
                                {displayStatus=='none'? <View></View>:<Slider
