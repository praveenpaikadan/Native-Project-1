            ...
            <View style={{...styles.overlay}}>
                <View style={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
                        <ButtonType1 text={"TODAY'S WORKOUT"} arrow={false} styling={styles.button} textStyling={styles.buttonText} />
                        <ButtonType1 text={"WORKOUT HISTORY"} arrow={false} styling={styles.button} textStyling={styles.buttonText} />
                    </View>
                </View>  
            </View>
        </Modal>
